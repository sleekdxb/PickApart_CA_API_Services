...
class VendorController extends Controller
{
    ...
    public function setFileStateById(Request $request)
    {
        ...
        $validatedData = Validator::make($request->all(), [
            ...
            'file_expiry_data.proof_expiry_data' => 'nullable|string', // Validate 'id' as a string
            'file_expiry_data.tax_expiry_data' => 'nullable|string', // Validate 'type' as a string
            'file_expiry_data.trad_expiry_data' => 'nullable|string', // Validate 'time' as a string
            'file_expiry_data.auth_person_expiry_data' => 'nullable|string',
            'file_expiry_data.em_expiry_data' => 'nullable|string',
            'file_expiry_data.passport_expiry_data' => 'nullable|string',
        ]);
