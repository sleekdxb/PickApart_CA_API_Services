...
class Part extends Model
{
    ...
    {
        return $this->hasMany(Impression::class, 'part_id', 'part_id'); // vend_id is the foreign key
    }
    ...
    {
        return $this->hasMany(Notification::class, 'vend_id', 'vend_id'); // vend_id is the foreign key
    }
    public function account_notification()
    {
        return $this->hasMany(AccountNotification::class, 'acc_id', 'acc_id'); // vend_id is the foreign key
    }
