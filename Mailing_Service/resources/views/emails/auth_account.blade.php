...
<body style="background-color: #fff3e0; font-family: Arial, sans-serif; margin: 0; padding: 0;">
  <div style="max-width: 600px; margin: auto; background-color: #fcfcfc; padding: 40px; border-radius: 8px;">
    ...
    <!-- Greeting -->
    <h4>Hi {{ $name ?? 'there' }},</h4>
    <h2>{{ $subject ?? 'Your account has been logged in from a new device.' }}</h2>
    <p>If this was you, please confirm by entering the One-Time Password (OTP) sent to your registered email.</p>
    ...
    <p>If this wasn’t you, secure your account immediately by changing your password and reviewing your login activity.</p>
