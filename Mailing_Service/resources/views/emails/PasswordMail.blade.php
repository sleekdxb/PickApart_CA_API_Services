...
<body style="background-color: rgba(255, 227, 179, 0.24);">
    <div class="container" style="container" style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 50px; background-color: rgb(252, 252, 252)">
        ...
        <h4>Hi, {{ $name }},</h4>
        <h2>{{ $subject }}</h2>
        <p>Thank you for creating your <span>pick-a-part.ca</span> account. Please enter this code to verify your email address:</p>

        <div style="text-align: center;">
          <form style="text-align: center; item-align: center; margin: 20px 10; text-align: center;">
            <div style="display: flex; justify-content: center; gap: 15px;">
                @foreach($data['data'] as $digit)
                    <input type="text" value="{{ $digit }}" style="margin-left:10px; width: 30px; height: 40px; text-align: center; font-size: 18px;" readonly>
                @endforeach
            </div>
        ...
        <p>If you have any issues with verification, please contact <a href="mailto:support@pick-a-part.ca">support@pick-a-part.ca</a>.</p>
