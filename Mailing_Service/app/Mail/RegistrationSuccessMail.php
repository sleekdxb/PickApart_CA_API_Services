...
class RegistrationSuccessMail extends Mailable
{
    ...
    {
        return new Content(
            view: 'emails.RegistrationSuccessMail', // Ensure this view exists in resources/views/emails/verify_account.blade.php
            with: [
                'data' => $this->data['data'],
                'name' => $this->data['name'],   // Send name to the view
                'subject' => $this->data['subject'],  // Send subject to the view
                'emailMessage' => $this->data['message'],  // Assuming 'message' exists in the form data
            ],
        );
    }
