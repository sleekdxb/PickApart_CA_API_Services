...
class Garage_VendorCearationCreatedMail extends Mailable
{
    ...
    {
        return new Content(
            view: 'emails.GarageVendorCearationCreatedMail', // Ensure this view exists in resources/views/emails/verify_account.blade.php
            with: [
                ...
                // Assuming 'message' exists in the form data
            ],
        );
    }
